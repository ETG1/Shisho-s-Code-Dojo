...
>
            <SignUp.Root>
                ...
                >
                    ...
                    <div className="space-y-4">
                        <Clerk.Field name="emailAddress" className="space-y-1">
                            ...
                            <Clerk.Input
                                type="email"
                                required
                                className="w-full px-3 py-2 bg-zinc-900 border-2 border-black shadow-[3px_3px_0_0_#000] outline-none focus:border-gray-400 text-white"
                            />
                    ...
                    <SignUp.Action submit className="w-full px-4 py-2 bg-gray-400 border-2 border-black shadow-[4px_4px_0_0_#000] active:translate-y-[2px] active:shadow-none text-black font-bold uppercase">
                        Sign Up
                    </SignUp.Action>
                ...
                >
                    <header className="text-center">
                        <h1 className="mt-3 text-base font-bold tracking-wide text-gray-400 uppercase">Verify Email Code</h1>
                    </header>

                    <Clerk.GlobalError className="block text-sm text-red-500" />
                    <SignUp.Strategy name="email_code">
                        <Clerk.Field name="code" className="space-y-1">
                            <Clerk.Label className="font-bold text-gray-400 uppercase">Email Code</Clerk.Label>
                            <Clerk.Input type="otp" required className="w-full px-3 py-2 bg-zinc-900 border-2 border-black shadow-[3px_3px_0_0_#000] outline-none focus:border-gray-400 text-white" />
                            <Clerk.FieldError className="text-sm text-red-500" />
                        </Clerk.Field>
                        <SignUp.Action submit className="w-full px-4 py-2 bg-gray-400 border-2 border-black shadow-[4px_4px_0_0_#000] active:translate-y-[2px] active:shadow-none text-black font-bold uppercase">
                            Verify
                ...
                >
                    <header className="text-center">
                        <h1 className="mt-3 text-base font-bold tracking-wide text-gray-400 uppercase">Continue Registration</h1>
                    </header>

                    <Clerk.GlobalError className="block text-sm text-red-500" />
                    <Clerk.Field name="username" className="space-y-1">
                        <Clerk.Label className="font-bold text-gray-400 uppercase">Username</Clerk.Label>
                        <Clerk.Input type="text" required className="w-full px-3 py-2 bg-zinc-900 border-2 border-black shadow-[3px_3px_0_0_#000] outline-none focus:border-gray-400 text-white" />
                        <Clerk.FieldError className="text-sm text-red-500" />
                    </Clerk.Field>
                    <SignUp.Action submit className="w-full px-4 py-2 bg-gray-400 border-2 border-black shadow-[4px_4px_0_0_#000] active:translate-y-[2px] active:shadow-none text-black font-bold uppercase">
                        Continue
