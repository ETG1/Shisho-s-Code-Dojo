  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-5 mt-3'>
        {courseList?.map((course, index) => (
            <div key={index} className='border-4  rounded-md hover:bg-zinc-900 cursor-pointer'>
                ...
                <div className='p-4'>
                    ...
                    <h2 className='bg-zinc-900 px-4 flex gap-2 font-game p-1 mt-3 rounded-lg items-center inline-flex'>
